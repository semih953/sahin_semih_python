...
class TicketGenerator:
    ...
    def generate_ticket(self, ticket_data, background_image):
        ...
        draw.text((category_x, category_y), ticket_data['categorie'], fill=couleur_blanche, font=paris_font)
        draw.text((place_x, place_y), ticket_data['place'], fill=couleur_blanche, font=paris_font)
        draw.text((prix_x, prix_y), ticket_data['prix'], fill=couleur_blanche, font=paris_font)
